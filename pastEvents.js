...
let contenedorChekbox = document.getElementById("contenedor-checkbox-PE")
...
function mostrarEventos(eventos) {
    ...
    if (eventos.length === 0) {
        ...
        eventos.forEach(evento => {
            ...
            `
            contenedorPE.appendChild(tarjeta)
        })
    }
}
...
function obtenerCategoriasSeleccionadas() {
    let checkboxes = document.querySelectorAll('#contenedor-checkbox-PE input[type="checkbox"]:checked');
